...
namespace AdmissionsCommittee.Data.Repository
{
    public class EmployeeRepository : BaseRepository<Employee>, IEmployeeRepository
    {
        ...
        {
            var speciality = await Connection.QueryAsync<Employee, Faculty, Person, Working, Rank, Employee>(query,
            ...
            if (speciality.Any(x => x.Working is not null))
            {
                return speciality.GroupBy(p => p.EmployeeId).Select(g =>
                {
